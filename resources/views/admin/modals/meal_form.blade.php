...
<div class="modal fade" id="add_meal_form" tabindex="-1" style="display: none;">
    <div class="modal-dialog modal-xl">
        <div class="modal-content rounded">
            <div class="modal-header border-5 pb-0 mb-4 w-100 d-flex justify-content-between align-items-center">
                <h5 class="modal-title text-start w-100" id="exampleModalLabel">New Meal</h5>
            ...
            <div class="modal-body pt-0">
                <form id="menuOrderMealForm" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <label class="form-check form-check-custom form-check-inline me-2">
                                                    <input class="form-check-input" name="is_autoselectable"
                                                        type="checkbox" value="1" {{ @$formData['is_autoselectable'] == 1 ? 'checked=""' : '' }}
                            ...
                            <div class="row mb-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="description" class="form-control form-control-sm" placeholder="Description" rows="5"></textarea>
                                </div>
                            </div>
                            <div class="row mb-6 align-items-center">
                                <div class="col-lg-4">
                                        ...
                                        <select id="meal_type_dropdown" required name="meal_type_id"
                                            ...
                                            @foreach ($mealTypes as $mealType)
                                                <option
                                                    ...
                                                    value="{{ $mealType->uuid }}"
                                                    {{ $mealType->uuid == request('meal_type_id') || $mealType->uuid == $mealTypeUuid ? 'selected' : '' }}>
                                                    {{ $mealType->title }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input required type="text" class="form-control form-control-sm" value="{{ @$formData['price']  }}"
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="company_name *"
                                            class="required col-form-label fw-semibold fs-6">Featured
                                            Image</label>
                                        <input required class="form-control form-control-sm" placeholder=""
                ...
                container.append(`
                    <div class="unique-container add_menu_item ${isAdded ? 'meal-added' : ''}"
                        ...
                        <div class="unique-container__card ${isAdded ? 'border-success' : ''}">
                            ...
                            <!-- Title Component -->
                            <div class="unique-container__title mt-3">
                                <h3>${meal.title}</h3>
                            </div>
                            <!-- Description Component -->
                            <div class="unique-container__description mt-2">
                                <p>${meal.description || "No description available."}</p>
                            </div>
                            <!-- Price Component -->
                            <div class="unique-container__price mt-3">
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.success) {
                    ...
                    getMealTypesAjax("{{ request('meal_type_id') }}")
                } else {
