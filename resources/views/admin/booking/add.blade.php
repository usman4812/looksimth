                                ...
                                <div class="row mb-6 align-items-center">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" id="date-input" name="date" class="form-control form-control-sm">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label for="Phone" class="col-form-label fw-semibold fs-6">From</label>
                                            <input type="time" id="form" name="from" class="form-control form-control-sm">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-lg-6 mt-10">
                                        <div class="flex flex-col items-start ">
                                            <label class="form-label flex items-center gap-2.5">
                                                <input class="checkbox" name="instance" type="checkbox" value="1" />
                                                Instance
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control form-control-sm" placeholder="" name="description" type="text" row="4"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
