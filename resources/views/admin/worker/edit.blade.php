...
<div class="d-flex flex-column flex-column-fluid">
    ...
    <div id="kt_app_content" class="app-content  flex-column-fluid ">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('worker.edit', $worker->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card">
                            ...
                            <div class="row mb-6 align-items-center">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input required type="text" name="name" value="{{$worker->name}}"
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input required type="email" name="email" value="{{$worker->email}}"
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="phone" value="{{$worker->phone}}"
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control form-control-sm" name="service_id">
                                            ...
                                            <option value="{{$service->id}}" {{ $service->id == $worker->service_id ? "selected" : '' }}> {{$service->title}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="flex flex-col items-start gap-10">
                                        <label class="form-label flex items-center gap-2.5">
                                            <input class="radio" name="gender" type="radio" value="male"
                                                {{ isset($worker) && $worker->gender == "male" ? "checked" : "" }} />
                                            Male
                                        </label>
                                        <label class="form-label flex items-center gap-2.5">
                                            <input class="radio" name="gender" type="radio" value="female"
                                                {{ isset($worker) && $worker->gender == "female" ? "checked" : "" }} />
                                            Female
                                        </label>
                                    </div>
                                </div>
                                <div class="col-lg-6 mt-5">
                                    <div class="flex flex-col items-start">
                                        <label class="form-label flex items-center gap-2.5">
                                            <input class="checkbox" name="status" type="checkbox" value="1"  {{ $worker->status == 1 ? "checked" : "" }}/>
                                            Active Status
                                        </label>
                                    </div>
                                </div>
