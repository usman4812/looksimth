                            ...
                            <div class="row mb-6 align-items-center">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="price" step="0.001" min="0"
                                            class="form-control form-control-sm" placeholder="Pricce" maxlength="10">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="percent" step="0.001" min="0"
                                            class="form-control form-control-sm" placeholder="Discount Percent" maxlength="3">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-12 mb-6">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" class="form-control form-control-sm" placeholder="Description" rows="3"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
