...
@section('content')
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div id="kt_app_content" class="app-content  flex-column-fluid">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.gift.cards.edit', ['uuid' => $uuid]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="col-lg-12 w-100 d-flex justify-content-between align-items-start gap-5 flex-column">
                            <div class="card w-100 h-100 col-lg-12">
                                ...
                                <div class="card-body">
                                    <div class="row mb-3 align-items-start justify-content-start">
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <input required type="text" name="purchaser_first_name"
                                                    value="{{ $edit_gift_card->purchaser_first_name }}"
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <input required type="text" name="purchaser_last_name"
                                                    value="{{ $edit_gift_card->purchaser_last_name }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="position-relative">
                                                    <input type="email" name="purchaser_email" required
                                                        value="{{ $edit_gift_card->purchaser_email }}"
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <label for="purchaser_phone*"
                                                    class="required col-form-label fw-semibold fs-6">Purchaser Phone</label>
                                                <input required type="integer" name="purchaser_phone"
                                                    value="{{ $edit_gift_card->purchaser_phone }}"
                                                    class="form-control form-control-sm" placeholder="Purchaser Phone">
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <label for="company_name *"
                                                    class="required col-form-label fw-semibold fs-6">Purchased
                                                    Amount</label>
                                                <div class="input-group">
                                                    <span class="input-group-text">$</span>
                                                    <input required type="number" class="form-control form-control-sm"
                                                        name="purchased_amount" value="{{ $edit_gift_card->purchased_amount }}"
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <select required id="gift_type" name="gift_type"
                                                   ...
                                                   <option value="Donation" {{ $edit_gift_card->gift_type == 'Donation' ? 'selected' : '' }}>Donation</option>
                                                   <option value="Regular" {{ $edit_gift_card->gift_type == 'Regular' ? 'selected' : '' }}>Regular</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <label for="to*"
                                                    class="required col-form-label fw-semibold fs-6">To</label>
                                                <input required type="text" name="recipient_name"
                                                    value="{{ $edit_gift_card->recipient_name }}"
                                                    class="form-control form-control-sm" placeholder="Recipient Name">
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <label for="sender_name*"
                                                    class="required col-form-label fw-semibold fs-6">From</label>
                                                <input required type="text" name="sender_name"
                                                    value="{{ $edit_gift_card->sender_name }}"
                                                    class="form-control form-control-sm" placeholder="Sender Name">
                                            </div>
                                        </div>
                                        <div class="row mb-6">
                                            <div class="form-group">
                                                <label for="message*"
                                                    class="col-form-label fw-semibold fs-6">Message</label>
                                                <textarea name="message" class="form-control form-control-lg" placeholder="Add a message (Optional)" rows="3">{{ $edit_gift_card->message }}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 mb-9">
                                            <div class="form-group">
                                                <label for="customer_user_id*"
                                                    class="required col-form-label fw-semibold fs-6">Assign to
                                                    customer</label>
                                                <select id="customer_user_id" name="customer_user_id"
                                                    ...
                                                    @foreach ($customers as $customer)
                                                        <option value="{{ $customer->uuid }}" {{ $customer->uuid == $edit_gift_card->customer_user_id ? 'selected' : '' }}>{{ $customer->name }} - {{ $customer->email }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 mt-10">
                                            <label class="mt-5 form-check form-check-custom form-check-inline  me-5">
                                                <input class="form-check-input" name="is_active" type="checkbox"
                                                    value="1" {{ $edit_gift_card->is_active == 1 ? 'checked' : '' }} data-gtm-form-interact-field-id="1">
                            ...
                            <div class="w-100 d-flex justify-content-end py-0 px-0">
                                <button type="submit"
                                    class="btn btn-sm btn-primary d-flex justify-content-center align-items-center">Update</button>
                            </div>
                        </div>
                    </form>
                </div>
