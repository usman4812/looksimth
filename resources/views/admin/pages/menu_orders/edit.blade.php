...
@section('content')
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div id="kt_app_content" class="app-content mt-6 flex-column-fluid ">
            <form id="menuForm" action="{{ route('admin.menus.edit', ['uuid' => $uuid]) }}" method="POST"
                ...
                <div class="card-body">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-12 mt-0">
                                    <div class="form-group">
                                        ...
                                        <input required type="text" name="title" value="{{ $editMenuOrder->title }}"
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-12 mt-0">
                                    <div class="form-group">
                                        ...
                                        <input required type="date" name="delivery_date"
                                            value="{{ $editMenuOrder->delivery_date }}" class="form-control form-control-sm"
                                            placeholder="">
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-12 mt-1">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="custom_delivery_date"
                                            value="{{ $editMenuOrder->custom_delivery_date }}"
                                            class="form-control form-control-sm" placeholder=""
                                            min="{{ \Carbon\Carbon::now()->toDateString() }}">
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-12 mt-1">
                                    <div class="form-group">
                                        <label for="custom_delivery_hours *"
                                            class="col-form-label fw-semibold fs-lg-5 fs-md-6 fs-sm-6">Custom
                                            delivery hours (e.g. 12pm - 5pm)</label>
                                        <input type="text" name="custom_delivery_hours"
                                            value="{{ $editMenuOrder->custom_delivery_hours }}"
                                            class="form-control form-control-sm" placeholder="">
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-12 mt-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="custom_pickup_hours"
                                            value="{{ $editMenuOrder->custom_pickup_hours }}"
                                            class="form-control form-control-sm" placeholder="">
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-12 mt-1">
                                    <div class="form-group">
                                        <div class="d-flex justify-content-between align-items-center w-100">
                                            <label for="deadline_date *" class="col-form-label fw-semibold fs-lg-5 fs-md-6 fs-sm-6">Custom
                                                order
                                                deadline date</label>
                                        ...
                                        <div class="input-group  d-flex align-items-center">
                                            <input type="date" name="deadline_date"
                                                value="{{ $editMenuOrder->deadline_date }}"
                                                class="form-control form-control-sm" placeholder=""
                                                min="{{ \Carbon\Carbon::now()->toDateString() }}">
                                        </div>
                                    </div>
                                            ...
                                            <div class="d-flex align-items-center">
                                                <label class="form-check form-check-custom form-check-inline me-2">
                                                    <input class="form-check-input" name="is_active" type="checkbox"
                                                        ...
                                                        {{ $editMenuOrder->is_active == 1 ? 'checked' : '' }}>
                                            ...
                                            <div class="d-flex align-items-center">
                                                <label class="form-check form-check-custom form-check-inline me-2">
                                                    <input class="form-check-input" name="is_public" type="checkbox"
                                                        value="1" data-gtm-form-interact-field-id="1"
                                                        {{ $editMenuOrder->is_public == 1 ? 'checked' : '' }}>
                                                    <span class="fw-semibold ps-2 fs-6">
                                                        Public
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 mt-1">
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" name="note" class="form-control form-control-sm" placeholder="">{{ $editMenuOrder->note }}</textarea>
                            ...
                            {{-- <div class="row mb-6 align-items-center">
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-12 mt-1">
                                    <div class="form-group">
                                        <label for="custom_delivery_hours *"
                                            class="col-form-label fw-semibold fs-5">Custom
                                            delivery hours (e.g. 12pm - 5pm)</label>
                                        <input type="text" name="custom_delivery_hours"
                                            value="{{ $editMenuOrder->custom_delivery_hours }}"
                                            class="form-control form-control-sm" placeholder="">
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-12 mt-1">
                                    <div class="form-group">
                                        <div class="d-flex justify-content-between align-items-center w-100">
                                            <label for="deadline_date *" class="col-form-label fw-semibold fs-5">Custom
                                                order
                                                deadline date</label>
                                            <p class="text-gray-700 mt-4"> at 12pm</p>
                                        </div>
                                        <div class="input-group  d-flex align-items-center">
                                            <input type="date" name="deadline_date"
                                                value="{{ $editMenuOrder->deadline_date }}"
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 mt-1">
                                    <div class="form-group">
                                        <label for="note *" class="col-form-label fw-semibold fs-5">Add Note</label>
                                        <textarea type="text" name="note" class="form-control form-control-sm" placeholder="">{{ $editMenuOrder->note }}</textarea>
                                    </div>
                                    <div class="fs-6 text-primary pe-7">[DELIVERY_OPTION] will be auto-replaced by the
                                        user's chosen delivery option</div>
                    ...
                    <div class="d-flex justify-content-start py-5 pe-9 gap-2">
                        ...
                        <button type="button" id="openMealFormModal"
                            class="btn btn-sm light-latest-container ms-3 d-flex align-items-center justify-content-center"><i
                    ...
                    <div class="menu-items-container">
                        @foreach ($mealTypes as $mealType)
                            <div class="card mt-5 mb-5 w-100 h-100 col-lg-12">
                                <div class="card-header rest-padding" style="background: #ddd;">
                                    <h2 class="card-title fs-3">{{ $mealType->title }}</h2>
                                </div>
                                <div class="card-body {{ $mealType->uuid }}">
                                    <div class="col-lg-12 meal-order-card-section ">
                                        @if (isset($mealTypesWithMeals[$mealType->uuid]))
                                            @foreach ($mealTypesWithMeals[$mealType->uuid] as $meal)
                                                @php
                                                    $imageBasePath = asset('storage/public/web_assets/media/meals');
                                                    $imageUrl = "{$imageBasePath}/{$meal->uuid}/{$meal->image}";
                                                @endphp
                                                    ...
                                                    <div class="meal-order-main-outer-card-section">
                                                        <div class="meal m-0 added-meal" data-uuid="{{ $meal->uuid }}">
                                                            <div class="d-flex align-items-center justify-content-between w-100">
                                                                {{-- <div class="meal-order-image-section"> --}}
                                                                ...
                                                                <div class="details ms-3 w-100">
                                                                    ...
                                                                    <div class="meal-order-inner-prise-buttons">
                                                                        <div class="controls d-flex gap-1">
                                                                            ...
                                                                            <div class="button-container">
                                                                                <button
                                                                                    class="btn btn-sm btn-danger remove_menu_item">
                                                                                    <i class="fa-solid fa-trash"></i>
                                                                                </button>
                                                                                <div class="toggle-tooltip">Remove Meal
                                                                                </div>
                                                                            </div>
                                                                        </div>
                ...
                <div class="d-flex justify-content-end py-3 px-5">
                    <button type="submit" class="btn btn-sm primary-latest-container"><i
                ...
                <div id="kt_app_settings_content" class="position-relative scroll-y me-n5 pe-5" data-kt-scroll="true"
                    ...
                    <div class="card-body pt-2">
                        <ul class="nav nav-pills nav-pills-custom mb-3 nav-pills-custom-scroll" role="tablist"
                            style="justify-content: center;border-bottom: 1px solid #ddd;">
                            @foreach ($mealTypes as $index => $mealType)
                                <li class="nav-item mb-3 me-3 me-lg-6" role="presentation">
                                    <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4 {{ $index === 0 ? 'active' : '' }}"
                                        ...
                                        <div class="nav-icon">
                                            <img src="{{ asset('images/meal_types/' . $mealType->image) }}" alt="">
                                        </div>
...
@push('script')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.nav-link', function(e) {
                ...
                // Fetch meals for the selected meal type
            ...
            container.append(`
                                <div class="unique-container">
                                    <div class="unique-container__card add-meal-card">
                                        <a type="button" id="openMealFormModal" class="btn btn-sm btn-primary fw-bold ms-3" data-meal-type-uuid="${mealTypeUuid}">
    ...
    <script>
        ...
        `;
            if (targetCardBody.length) {
                targetCardBody.find('div:first').append(mealHtml);
                $(this).addClass('meal-added').css('border', '2px solid green');
            } else {
    ...
    <script>
        document.querySelectorAll('.button-container').forEach(container => {
            ...
            const toggle = container.querySelector('.toggle-content');
