                    ...
                    <form action="{{ route('admin.user.add') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 fv-row">
                                            <input type="text" required name="fname"
                                                ...
                                                placeholder="First name" value="{{ @$formData['fname'] }}" />
                                            @error('fname')
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                    <input type="email" required name="email"
                                        class="form-control form-control-lg form-control-solid"
                                        value="{{ @$formData['email'] }}" placeholder="Email Address">
                                    @error('email')
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <select required name="role_id" aria-label="Select a Role"
                                        data-placeholder="Select a role..."
                                        class="form-select form-select-solid form-select-lg form-control">
                                        <option value="">Select a Role...</option>
                                        @foreach ($roles as $role)
                                            <option {{ @$formData['role_id'] == $role->id ? 'selected=""' : '' }} value="{{ $role->id }}">{{ $role->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('role_id')
                                        <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="d-flex justify-content-end py-6 px-9">
                            <button data-bs-toggle="tooltip" title="Create" type="submit" class="btn btn-sm primary-latest-container">
