@php
    $formData = old();
    $customerUuid = request()->segment(2);

    if ($customerUuid && $customerUuid !== 'add') {
...
@section('content')
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div id="kt_app_content" class="app-content  flex-column-fluid">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.customers.add') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="parent_id" value="{{ $customerUuid ?? '' }}" readonly />
                        <div class="col-lg-12 w-100 d-flex justify-content-between align-items-start gap-5 flex-column">
                            <div class="card w-100 h-100 col-lg-12">
                                <div class="card-header rest-padding-twenty" style="background: #ddd;">
                                    <h2 class="card-title m-0">Account Info</h2>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <input required type="text" name="name"
                                                    value="{{ @$formData['name'] }}" class="form-control form-control-sm"
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <input required type="email" name="email"
                                                    value="{{ @$formData['email'] }}" class="form-control form-control-sm"
                                                    placeholder="Email">
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <input required type="integer" name="phone"
                                                    value="{{ @$formData['phone'] }}" class="form-control form-control-sm"
                                                    placeholder="phone">
                                                <label class="mt-5 form-check form-check-custom form-check-inline  me-5">
                                                    <input class="form-check-input" name="text_enabled" type="checkbox"
                                                        ...
                                                        {{ @$formData['text_enabled'] == 1 ? 'checked=""' : '' }}>
                                            ...
                                            <div class="form-group">
                                                <div class="d-flex align-items-center justify-content-between">
                                                    ...
                                                    <button data-bs-toggle="tooltip" data-bs-placement="top"
                                                        ...
                                                        class="custom-btn main-customer-button"
                                                        id="openCustomerGroupModal">
                                                        <i class="ki-duotone ki-plus"></i>
                                                    </button>
                                                </div>
                                                <div class="d-flex align-items-center justify-content-start">
                                                    <select id="customer_group_dropdown" name="customer_group_id"
                                                        class="dropdown-select-box form-control form-control-sm">
                                                    ...
                                                    <div class="dropdown-icon-box" id="dropdownIconBox">
                                                        <i title="Meal Days & Order Deadline"
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <label for="*" class="col-form-label fw-semibold fs-6">Apt /
                                                    Unit</label>
                                                <input type="text" name="street2" value="{{ @$formData['street2'] }}"
                            ...
                            <div class="card w-100 h-100 col-lg-12">
                                <div class="card-header rest-padding-twenty" style="background: #ddd;">
                                    <h2 class="required card-title m-0">Meal Preferences</h2>
                                    {{-- <i class="fa-solid fa-sitemap"></i> --}}
                                    <i title="Meal Days & Order Deadline" class="fa-solid fa-sitemap"></i>
                                </div>
                                <div class="card-body">
                                    <div class="row mb-6 ingredient-container">
                                        <div class="infredients-titles">Please check if they can eat the item:</div>
                                    ...
                                    <div class="row mb-6 diets-container">
                                        <div class="infredients-titles">Please check any dietary requirements:</div>
                            ...
                            <div class="card w-100 h-100 col-lg-12">
                                <div class="card-header rest-padding-twenty" style="background: #ddd;">
                                    <h2 class="card-title m-0">Delivery or Pickup</h2>
                                    {{-- <i class="fa-solid fa-truck-ramp-box"></i> --}}
                                    <i title="Meal Days & Order Deadline" class="fa-solid fa-truck-ramp-box"></i>
                                </div>
                                <div class="card-body">
                                    <div class="text-center infredients-titles">How do you want to receive your meals?</div>
                                        ...
                                        <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                                            ...
                                            <div class="d-flex flex-column align-items-center text-center mt-5"
                                                ...
                                                <div class="col-lg-2 mb-4">
                                                    ...
                                                    <input type="text" class="form-control form-control-sm"
                                                        name="driver_number" value="{{ @$formData['driver_number'] }}"
                                                        placeholder="Driver #" />
                                                </div>
                            ...
                            <div class="w-100 d-flex justify-content-end py-0 px-0">
                                <button type="submit"
                                    class="btn btn-sm primary-latest-container d-flex justify-content-center align-items-center">
