                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="unit" class="form-control form-control-sm"
                                        value="{{ @$formData['unit'] }}" placeholder="Unit">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label for="plan_type_id*" class="required col-form-label fw-semibold fs-6">Plan
                                        Type</label>
                                    <select id="plan_type_id" name="plan_type_id" data-placeholder="Select a Plan Type..."
                                        class="form-control form-control-sm">
                                        <option value="">Select Plan Type</option>
                                        @foreach ($plan_types as $plan_type)
                                            <option value="{{ $plan_type->uuid }}">{{ $plan_type->title }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="card-body">
                                <div class="row mb-6 align-items-center">
                                    <div class="col-lg-4">
                                        <div class="d-flex align-items-center">
                                            <label class="form-check form-check-custom form-check-inline  me-2">
                                                <input class="form-check-input" name="plan_variants[0][is_public]"
                                ...
                                <div class="row mb-6 align-items-center">
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <input required type="text" name="plan_variants[0][quantity]"
                                                    class="form-control form-control-sm"
                                                    value="{{ @$formData['quantity'] }}" placeholder="">
                                            ...
                                            <div class="d-flex align-items-center mt-3">
                                                <label
                                                    ...
                                                    <input class="form-check-input" name="plan_variants[0][quantity_min]"
                                    ...
                                    <div class="col-lg-3 mb-9">
                                        <div class="form-group">
                                            <label for="password*" class="required col-form-label fw-semibold fs-6">Meal
                                                Size</label>
                                            <select id="meal_size_id" name="plan_variants[0][meal_size_id]"
                                    ...
                                    <div class="col-lg-3 mb-9">
                                        <div class="form-group">
                                            <label for="password*" class="required col-form-label fw-semibold fs-6">Price
                                                Per Week</label>
                                            <div class="input-group">
                                                <span class="input-group-text">$</span>
                                                <input type="integer" class="form-control form-control-sm"
                                                    name="plan_variants[0][price_per_week]"
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-text">$</span>
                                                <input type="integer" class="form-control form-control-sm"
                                                    name="plan_variants[0][price_per_unit]"
                                                    aria-label="Amount (to the nearest dollar)" />
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-center mt-3">
                                            <label class="form-check form-check-custom form-check-inline  me-5 is-valid">
                                                <input class="form-check-input"
                                                    name="plan_variants[0][price_per_unit_starting_at]" type="checkbox"
                                                    value="1" data-gtm-form-interact-field-id="1">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-2">
                                            ...
                                            <input type="number" class="form-control form-control-sm"
                                                name="plan_variants[0][num_meals_any]"
                                                value="{{ @$formData['num_meals_any'] }}" placeholder="Any" />
                                        </div>
                                        <div class="col-lg-2">
                                            <label class="fw-semibold fs-6">Breakfast:</label>
                                            <input type="number" class="form-control form-control-sm"
                                                name="plan_variants[0][num_meals_breakfast]"
                                        ...
                                        <div class="col-lg-2">
                                            ...
                                            <input type="number" class="form-control form-control-sm"
                                                name="plan_variants[0][num_meals_lunch]"
                                                value="{{ @$formData['num_meals_lunch'] }}" placeholder="Lunch" />
                                        </div>
                                        <div class="col-lg-2">
                                            <label class="fw-semibold fs-6">Dinner:</label>
                                            <input type="number" class="form-control form-control-sm"
                                                name="plan_variants[0][num_meals_dinner]"
                                                value="{{ @$formData['num_meals_dinner'] }}" placeholder="Dinner" />
                                        </div>
                                        <div class="col-lg-2">
                                            <label class="fw-semibold fs-6">Lunch/Dinner:</label>
                                            <input type="number" class="form-control form-control-sm"
                                                name="plan_variants[0][num_meals_lunch_dinner]"
                                ...
                                <div class="row mb-6 align-items-center">
                                            ...
                                            <table class="table" id="meal_size_table">
                                                ...
                                                @foreach ($mealDay as $key => $day)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text"
                                                                name="plan_variants[0][mealDay][auto_any_{{ $key }}]"
                                                                id="auto_any_0_{{ $key }}"
                                                                class="form-control form-control-sm" placeholder="">
                                                        </td>
                                                        <td>
                                                            <input type="text"
                                                                name="plan_variants[0][mealDay][auto_breakfast_{{ $key }}]"
                                                                id="auto_breakfast_0_{{ $key }}"
                                                                class="form-control form-control-sm" placeholder="">
                                                        </td>
                                                        <td>
                                                            <input type="text"
                                                                name="plan_variants[0][mealDay][auto_lunch_dinner_{{ $key }}]"
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <select id="meal_type_dropdown" name="plan_variants[0][prefer_meal_type_id]"
                                ...
                                <div class="row mb-6">
                                    <div class="form-group">
                                        <label for="description" class="col-form-label fw-semibold fs-6">Additional
                                            ...
                                            data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click"
                                            data-bs-placement="top"></i>
                                        <textarea name="plan_variants[0][description]" class="form-control form-control-sm" placeholder="Description"
                                            rows="3"></textarea>
                                    </div>
                                </div>
                            </div>
