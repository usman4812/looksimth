    ...
    <div class="d-flex flex-column flex-column-fluid">
        <div id="kt_app_toolbar" class="app-toolbar  d-flex flex-stack py-4 py-lg-8 ">
            <div class="d-flex flex-grow-1 flex-stack flex-wrap gap-2 mb-n10" id="kt_toolbar">
                ...
                {{-- @can('create services')
                    <a href="{{ route('service.add') }}" class="btn btn-sm primary-latest-container fw-bold">
...
@push('script')
    ...
    <script>
        var appUserTable = $('#appUserTable').DataTable({
            "pageLength": 25,
            "filter": true,
            "searching": true,
            "responsive": true,
        ...
        $('#search').keyup(function() {
            appUserTable.search($(this).val()).draw();
        });
    </script>
    ...
    <script>
        $(document).on("click", ".delete-btn", function(event) {
            ...
            var id = $(this).data('id');
            var url = "{{ route('service.delete', ':id') }}".replace(':id', id);
            Swal.fire({
                title: 'Are you sure?',
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if (response.success) {
                                ...
                                $('#appUserTable').DataTable().ajax.reload(null, false);
                            } else {
